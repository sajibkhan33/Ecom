...
class Cart(BaseModel):
    ...
    def get_cart_total(self):
        ...
        for cart_item in cart_items:
            ...
            if cart_item.size_variant:  # Corrected attribute name
                size_variant_price = cart_item.size_variant.price  # Corrected attribute name
        ...
        if self.coupon:
           ...
           if self.coupon.minimum_amount < sum(price):               
               return sum(price) - self.coupon.discount_price  # Changed Coupon to coupon
